function createDataset(fields, constraints, sortFields) {
    ...
    try {
        ...
        var fileName = "MOTIVO DESLIGAMENTO.CSV"; // NOVO ARQUIVO ALVO
        ...
        // ISO-8859-1 para preservar acentuações como ç e ã
        ...
        for (var i = 0; i < linhas.length; i++) {
            ...
            if (isFirstLine) {
                // Cria as colunas baseadas no cabeçalho (CODCLIENTE, DESCRICAO)
        ...
        log.error("--- ERRO DATASET MOTIVO DESLIGAMENTO SOAP: " + e.toString());
    }
